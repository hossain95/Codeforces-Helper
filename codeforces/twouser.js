document.getElementById("form2").addEventListener("submit", (e)=>
{
    ...
    }).then(([userinfo1, status1, status2, participate1, participate2]) =>
    {
        ...
        document.getElementById("h5").innerText = "Rating";
        ...
        document.getElementById("h6").innerText = "Rank";
        ...
        trySolvedFunction();
        document.getElementById("h7").innerText = "Tried & Solved";
        ...
        document.getElementById("h8").innerText = "Verdict";
        ...
        lavelSolvedFunction()
        document.getElementById("h9").innerText = "Category";
        //display
