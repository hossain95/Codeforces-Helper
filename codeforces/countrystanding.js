document.getElementById("form4").addEventListener("submit", (e)=>
{
    ...
    }).then(([AllUser, Round]) =>
    {
        ...
        console.log(info);
        document.getElementById("tableCountryName").innerText = countryName;
        ...
        document.getElementById("table2").style.borderWidth = "2px";
        ...
        document.getElementById("twoUserOutput").style.display = "none";
        document.getElementById("standing1").style.display = "none";
        document.getElementById("standing2").style.display = "";
    }).catch((e) =>
    {
        console.log(e);
        document.getElementById("loading").style.display = "none";
